...
namespace imgui_addons
{
    ...
    bool ImGuiFileBrowser::renderNavAndSearchBarRegion()
    {
        ...
        ImGui::BeginChild("##NavigationWindow", nw_size, ImGuiChildFlags_Border | ImGuiChildFlags_AutoResizeX | ImGuiChildFlags_AutoResizeY, ImGuiWindowFlags_NoScrollbar);
        ...
        ImGui::SameLine();
        ImGui::BeginChild("##SearchWindow", sw_size, ImGuiChildFlags_Border | ImGuiChildFlags_AutoResizeX | ImGuiChildFlags_AutoResizeY, ImGuiWindowFlags_NoScrollbar);
